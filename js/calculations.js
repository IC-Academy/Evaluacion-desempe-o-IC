...
(function (global) {
  ...
  // ===========================================================================
  // 1. PONDERACIÓN GENERAL (documento oficial, sección "PONDERACIÓN GENERAL")
  // ===========================================================================
  const PESOS_SECCION = {
  ...
  // ===========================================================================
  // 3. UMBRALES DE LA MATRIZ 9-BOX
  //    Configurables. Deben validarse por RH antes de producción.
  //    Escala 1-5 para cada eje (Actitud / Desempeño).
  // ===========================================================================
  const CONFIG_9BOX = {
    nivel1Max: 2.49,
    nivel2Max: 3.99,
  ...
  /**
   * actitudProm: promedio 1-5 de la sección A
   * desempenoProm: promedio ponderado 1-5 de B+C+D
